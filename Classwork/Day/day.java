...
// i know it's like semantic-y, but you should capitalize class names, there *is* reason for doing so.
...
class day {
  ...
  public String toString() {
    return "Today is a " + (percentChanceRain < 25 ? "sunny" : "cloudy")
      + " " + (schoolDay ? "school" : "non-school")
      + " day with a " + percentChanceRain + "% chance of rain.";
  }
}